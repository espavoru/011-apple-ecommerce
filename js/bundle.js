...
eval("var x = 0;\nvar y = 20;\nvar z = 0;\nvar bool = true;\nvar interval;\nvar cube = document.querySelector('.cube');\ndocument.querySelector('.top-x-control').addEventListener('click', function () {\n  cube.style.transform = \"rotateX(\".concat(x += 20, \"deg) rotateY(\").concat(y, \"deg) rotateZ(\").concat(z, \"deg)\");\n});\ndocument.querySelector('.bottom-x-control').addEventListener('click', function () {\n  cube.style.transform = \"rotateX(\".concat(x -= 20, \"deg) rotateY(\").concat(y, \"deg) rotateZ(\").concat(z, \"deg)\");\n});\ndocument.querySelector('.left-y-control').addEventListener('click', function () {\n  cube.style.transform = \"rotateX(\".concat(x, \"deg) rotateY(\").concat(y -= 20, \"deg) rotateZ(\").concat(z, \"deg)\");\n});\ndocument.querySelector('.right-y-control').addEventListener('click', function () {\n  cube.style.transform = \"rotateX(\".concat(x, \"deg) rotateY(\").concat(y += 20, \"deg) rotateZ(\").concat(z, \"deg)\");\n});\ndocument.querySelector('.top-z-control').addEventListener('click', function () {\n  cube.style.transform = \"rotateX(\".concat(x, \"deg) rotateY(\").concat(y, \"deg) rotateZ(\").concat(z -= 20, \"deg)\");\n});\ndocument.querySelector('.bottom-z-control').addEventListener('click', function () {\n  cube.style.transform = \"rotateX(\".concat(x, \"deg) rotateY(\").concat(y, \"deg) rotateZ(\").concat(z += 20, \"deg)\");\n});\n\nvar playPause = function playPause() {\n  if (bool) {\n    interval = setInterval(function () {\n      cube.style.transform = \"rotateX(\".concat(x, \"deg) rotateY(\").concat(y++, \"deg) rotateZ(\").concat(z, \"deg)\");\n    }, 100);\n  } else {\n    clearInterval(interval);\n  }\n};\n\nplayPause();\ndocument.querySelector('.cube__controls').addEventListener('mouseover', function () {\n  bool = false;\n  playPause();\n});\ndocument.querySelector('.cube__controls').addEventListener('mouseout', function () {\n  bool = true;\n  playPause();\n});\n\n//# sourceURL=webpack:///./src/blocks/cube/cube.js?");
...
eval("var watchBands = document.querySelector('.watches__bands');\nvar watchCases = document.querySelector('.watches__cases');\nvar watchTopControl = document.querySelector('.watches__control--top');\nvar watchRightControl = document.querySelector('.watches__control--right');\nvar watchBottomControl = document.querySelector('.watches__control--bottom');\nvar watchLeftControl = document.querySelector('.watches__control--left');\nvar axisY = 0;\nvar axisX = 0;\ndocument.querySelectorAll('.watches__control, .cube__controls a, .iphones__btn').forEach(function (control) {\n  control.addEventListener('click', function (e) {\n    e.preventDefault();\n  });\n});\n\nvar hideControl = function hideControl() {\n  if (axisY === -280) {\n    watchTopControl.classList.add('hide');\n  } else {\n    watchTopControl.classList.remove('hide');\n  }\n\n  if (axisY === 280) {\n    watchBottomControl.classList.add('hide');\n  } else {\n    watchBottomControl.classList.remove('hide');\n  }\n\n  if (axisX === 280) {\n    watchRightControl.classList.add('hide');\n  } else {\n    watchRightControl.classList.remove('hide');\n  }\n\n  if (axisX === -280) {\n    watchLeftControl.classList.add('hide');\n  } else {\n    watchLeftControl.classList.remove('hide');\n  }\n};\n\nwatchTopControl.addEventListener('click', function () {\n  watchCases.style.marginTop = \"\".concat(axisY -= 70, \"rem\");\n  hideControl();\n});\nwatchBottomControl.addEventListener('click', function () {\n  watchCases.style.marginTop = \"\".concat(axisY += 70, \"rem\");\n  hideControl();\n});\nwatchRightControl.addEventListener('click', function () {\n  watchBands.style.marginRight = \"\".concat(axisX += 70, \"rem\");\n  hideControl();\n});\nwatchLeftControl.addEventListener('click', function () {\n  watchBands.style.marginRight = \"\".concat(axisX -= 70, \"rem\");\n  hideControl();\n});\n\n//# sourceURL=webpack:///./src/blocks/watches/watches.js?");
